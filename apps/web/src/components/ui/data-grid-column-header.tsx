...
function DataGridColumnHeader<TData, TValue>({
  ...
  const headerLabel = () => {
    return (
      <div
        className={cn(
          'inline-flex h-full items-center gap-1.5 text-[0.8125rem] font-medium uppercase leading-[calc(1.125/0.8125)] tracking-wide text-table-header-foreground [&_svg]:size-3.5 [&_svg]:text-table-header-foreground [&_svg]:opacity-80',
          className,
        )}
      >
        {icon && icon}
  ...
  const headerButton = () => {
    return (
      <Button
        variant="ghost"
        className={cn(
          'h-7 -ms-2 rounded-md px-2 font-medium uppercase tracking-wide text-table-header-foreground hover:bg-foreground/10 data-[state=open]:bg-foreground/10 hover:text-table-header-foreground data-[state=open]:text-table-header-foreground [&_svg]:text-table-header-foreground [&_svg]:opacity-80',
          className,
        )}
  ...
  const headerPin = () => {
    return (
      <Button
        ...
        size="sm"
        variant="ghost"
        className="-me-1 size-7 rounded-md text-table-header-foreground hover:bg-foreground/10 hover:text-table-header-foreground [&_svg]:text-table-header-foreground"
